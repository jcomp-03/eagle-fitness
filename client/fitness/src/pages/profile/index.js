                            ...
                            <div className="profile-head">
                                ...
                                <div className="profile-info">
									<div className="profile-photo">
										<img src="images/profile/profile.png" className="img-fluid rounded-circle" alt=""></img>
									</div>
                        ...
                        <div className="card">
                            <div className="card-body">
                                <div className="profile-statistics mb-5">
                                    <div className="text-center">
                                        ...
                                        <div className="mt-4">
											...
											<a href="javascript:void()" className="btn btn-primary mb-1" data-toggle="modal" data-target="#sendMessageModal">Send Message</a>
                                        </div>
                                    </div>
									{/* <!-- Modal --> */}
														...
														<div className="row"> 
															<div className="col-lg-6">
																<div className="form-group">
																	<label className="text-black font-w600">Name <span className="required">*</span></label>
																	<input type="text" className="form-control" value="Author" name="Author" placeholder="Author"></input>
																</div>
															</div>
															<div className="col-lg-6">
																<div className="form-group">
																	<label className="text-black font-w600">Email <span className="required">*</span></label>
																	<input type="text" className="form-control" value="Email" placeholder="Email" name="Email"></input>
																</div>
															</div>
															<div className="col-lg-12">
																<div className="form-group">
															...
															<div className="col-lg-12">
																<div className="form-group mb-0">
																	<input type="submit" value="Post Comment" className="submit btn btn-primary" name="submit"></input>
																</div>
															</div>
														</div>
													</form>
                                ...
                                <div className="profile-blog mb-5">
                                    ...
                                    <img src="images/profile/1.jpg" alt="" className="img-fluid mt-4 mb-4 w-100"></img>
                                ...
                                <div className="profile-interest mb-5">
                                    ...
                                    <div className="row mt-4 sp4" id="lightgallery">
										<a href="images/profile/2.jpg" data-exthumbimage="images/profile/2.jpg" data-src="images/profile/2.jpg" className="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
											<img src="images/profile/2.jpg" alt="" className="img-fluid"></img>
										</a>
										<a href="images/profile/3.jpg" data-exthumbimage="images/profile/3.jpg" data-src="images/profile/3.jpg" className="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
											<img src="images/profile/3.jpg" alt="" className="img-fluid"></img>
										</a>
										<a href="images/profile/4.jpg" data-exthumbimage="images/profile/4.jpg" data-src="images/profile/4.jpg" className="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
											<img src="images/profile/4.jpg" alt="" className="img-fluid"></img>
										</a>
										<a href="images/profile/3.jpg" data-exthumbimage="images/profile/3.jpg" data-src="images/profile/3.jpg" className="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
											<img src="images/profile/3.jpg" alt="" className="img-fluid"></img>
										</a>
                                ...
                                <div className="profile-news">
                                    ...
                                    <div className="media pt-3 pb-3">
                                        <img src="images/profile/5.jpg" alt="image" className="mr-3 rounded" width="75"></img>
                                    ...
                                    <div className="media pt-3 pb-3">
                                        <img src="images/profile/6.jpg" alt="image" className="mr-3 rounded" width="75"></img>
                                        <div className="media-body">
                                            <h5 className="m-b-5"><a href="post-details.html" className="text-black">Collection of textile samples</a></h5>
                                            <p className="mb-0">I shared this on my fb wall a few months back, and I thought.</p>
                                        </div>
                                    ...
                                    <div className="media pt-3 pb-3">
                                        <img src="images/profile/7.jpg" alt="image" className="mr-3 rounded" width="75"></img>
                                        <div className="media-body">
                                            <h5 className="m-b-5"><a href="post-details.html" className="text-black">Collection of textile samples</a></h5>
                                            <p className="mb-0">I shared this on my fb wall a few months back, and I thought.</p>
                                        </div>
                                        ...
                                        <div className="tab-content">
                                            <div id="my-posts" className="tab-pane fade active show">
                                                <div className="my-post-content pt-3">
                                                    <div className="post-input">
														...
														<a href="javascript:void()" className="btn btn-primary light px-3"><i className="fa fa-link"></i> </a>
                                                        <a href="javascript:void()" className="btn btn-primary light mr-1 px-3"><i className="fa fa-camera"></i> </a><a href="javascript:void()" className="btn btn-primary">Post</a>
                                                    </div>
                                                    <div className="profile-uoloaded-post border-bottom-1 pb-5">
                                                        <img src="images/profile/8.jpg" alt="" className="img-fluid"></img>
                                                        ...
                                                        <button className="btn btn-primary mr-2"><span className="mr-2"><i
                                                                    className="fa fa-heart"></i></span>Like</button>
                                                        <button className="btn btn-secondary"  data-toggle="modal" data-target="#replyModal"><span className="mr-2"><i
                                                                    className="fa fa-reply"></i></span>Reply</button>
                                                    </div>
                                                    <div className="profile-uoloaded-post border-bottom-1 pb-5">
                                                        <img src="images/profile/9.jpg" alt="" className="img-fluid"></img>
														<a className="post-title" href="post-details.html"><h3 className="text-black">Collection of textile samples lay spread</h3></a>
                                                        <p>A wonderful serenity has take possession of my entire soul like these sweet morning of spare which enjoy whole heart.A wonderful serenity has take possession of my entire soul like these sweet morning
                                                            of spare which enjoy whole heart.</p>
                                                        <button className="btn btn-primary mr-2"><span className="mr-2"><i
                                            ...
                                            <div id="about-me" className="tab-pane fade">
                                                ...
                                                <div className="profile-lang  mb-5">
													...
													<a href="javascript:void()" className="text-muted pr-3 f-s-16"><i className="flag-icon flag-icon-us"></i> English</a> 
													<a href="javascript:void()" className="text-muted pr-3 f-s-16"><i className="flag-icon flag-icon-fr"></i> French</a>
                                                    <a href="javascript:void()" className="text-muted pr-3 f-s-16"><i className="flag-icon flag-icon-bd"></i> Bangla</a>
                                                </div>
                                                ...
                                                <div className="pt-3">
                                                    <div className="settings-form">
                                                        ...
                                                        <form>
                                                            ...
                                                            <div className="form-group">
                                                                <label>Address</label>
                                                                <input type="text" placeholder="1234 Main St" className="form-control"></input>
                                                            </div>
                                                            <div className="form-group">
                                                                <label>Address 2</label>
                                                                <input type="text" placeholder="Apartment, studio, or floor" className="form-control"></input>
                                                            </div>
                                                            <div className="form-row">
                                                                <div className="form-group col-md-6">
                                                                    <label>City</label>
                                                                ...
                                                                <div className="form-group col-md-4">
                                                                    <label>State</label>
                                                                    <select className="form-control default-select" id="inputState">
