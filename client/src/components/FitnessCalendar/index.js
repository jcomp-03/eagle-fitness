...
function FitnessCalendar() {
  ...
  const [newWorkout, setNewWorkout] = useState({name: '', workoutType: '', startTime: null, durationMinutes: null})
  ...
  const handleSubmitNewWorkout = () => {
    ...
    setNewWorkout({name: '', workoutType: '', startTime: null, durationMinutes: null});
  }
            ...
            <div className="card-body">
              ...
              <div>
                ...
                <div className="form-group">
                  ...
                  >
                    <option disabled value=""> -- Workout Type --</option>
                ...
                <button className="btn btn-primary btn-event w-100" onClick={handleSubmitNewWorkout}>
